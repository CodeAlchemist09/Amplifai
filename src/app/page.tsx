        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20 lg:pt-40 lg:pb-32 w-full">
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
            <span className="inline-flex items-center gap-2 text-xs sm:text-sm font-semibold uppercase tracking-[0.2em] text-lime mb-6 sm:mb-8">
              ...
              AI-Powered Website & Ad Studio for SMBs
            </span>
          </div>
          ...
          >
            Websites and ad creatives that make your business look like it belongs on the internet's front page.
          </h1>
          ...
          >
            Amplifai is a boutique AI studio building high-converting websites and scroll-stopping ad creative for salons, clinics, contractors, showrooms, and online stores — at a price small businesses can actually afford.
          </p>
            ...
            {[
              {
                ...
                desc: 'Fast, modern, mobile-first websites built with AI-accelerated design and hand-finished polish — so visitors turn into calls, bookings, and sales, not bounces.',
                link: '/services',
              },
              {
                icon: Play,
                title: 'Ad Creative That Stops the Scroll',
                desc: 'Educational, UGC-style, and platform-native video ads built with AI — designed to perform on Meta, TikTok, and beyond, without the agency price tag.',
                link: '/services',
              },
              {
                icon: Layers,
                title: 'Website + Ads, One Studio',
                desc: 'Your site and your ad creative, built together and built to match — one consistent brand experience from the first impression to the click.',
                link: '/services',
              },
            ].map(card => (
              <Link
              ...
              >
                <div className="w-12 h-12 bg-indigo/10 rounded-xl flex items-center justify-center mb-6">
                  <card.icon className="w-6 h-6 text-indigo" />
                </div>
                <h3 className="font-[family-name:var(--font-display)] text-xl font-semibold text-ink mb-3">
                  {card.title}
                </h3>
                <p className="text-gray-mid leading-relaxed mb-6">{card.desc}</p>
            ...
            {[
              {
                step: '01',
                title: 'Discover',
                desc: 'A quick conversation about your business, your customers, and what "success" looks like for this project.',
              },
              {
                step: '02',
                title: 'Design & Build',
                desc: 'We design and build using AI-accelerated tools, with a real human reviewing and refining every decision — nothing goes live half-baked.',
              },
              {
                step: '03',
                title: 'Launch',
                desc: 'Your website goes live, or your ad creative ships ready to run — fast, polished, and tested.',
              },
              {
                step: '04',
                title: 'Grow',
                desc: 'We check in on results and help you decide what to build or test next.',
              },
            ].map((item, i) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {[
              {
                icon: Zap,
                title: 'Boutique attention, AI-level speed',
                desc: 'You get senior-level design thinking, delivered in days, not months.',
              },
              {
                icon: DollarSign,
                title: 'Priced for small business',
                desc: 'No bloated retainers or agency overhead. Just the work, priced fairly.',
              },
              {
                icon: Palette,
                title: 'One studio, one voice',
                desc: 'Your website and ad creative are built to match, so your brand looks consistent everywhere.',
              },
              {
                icon: BarChart3,
                title: 'Data-backed creative',
                desc: 'Every ad and every page is built with a specific outcome in mind — not just to look nice.',
              },
            ].map(item => (
